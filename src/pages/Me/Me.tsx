...
import {
  IonPage, IonContent, IonAvatar, IonIcon, IonRow, IonCol, IonButton, IonModal
} from '@ionic/react';
import {
  checkmarkOutline, settingsSharp, camera, add, pencilSharp
} from 'ionicons/icons';
  ...
  return (
    <IonPage>
          ...
          <div className="section-upper">
            <div className="me-header" onClick={ handleViewProfile }>
              <IonAvatar className="avatar">
                <img src="assets/img/avatars/hieu.png" alt="" />
              </IonAvatar>
              <div>
              ...
              <IonCol size="auto">
                <IonRow className="me-button-group">
                  <IonCol className="ion-text-center">
                    <IonButton color="white" className="button-custom button-icon" onClick={ handleViewSettings }>
                  ...
                  <IonCol className="ion-text-center">
                    <div className="button-stack primary">
                      <IonButton color="white" className="button-custom button-lg button-icon button-brand" onClick={ handleViewEditProfile }>
                  ...
                  <IonCol className="ion-text-center">
                    <IonButton color="white" className="button-custom button-icon" onClick={ handleViewEditProfile }>
      ...
      <IonModal isOpen={ isTinderGoldOpen } cssClass="custom-modal-small">
        <TinderGold
          onClose={ () => setIsTinderGoldOpen(false) }
        />
      </IonModal>
    </IonPage>
  );
